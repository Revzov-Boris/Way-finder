package edu.rutmiit.demo.way_finder_contract.config;
...
@SecurityScheme(
        name = WaysApiContractConfig.SECURITY_SCHEME_BEARER,
...
public final class WaysApiContractConfig {
